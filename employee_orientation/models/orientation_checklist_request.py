...
class OrientationChecklistRequest(models.Model):
    ...
    request_name = fields.Char(string='Name',help="Nombre")
    request_orientation = fields.Many2one('employee.orientation', string='Employee Orientation',help="Orientación del empleado")
    ...
    partner_id = fields.Many2one('res.users', string='Responsible User',help="Usuario responsable")
    request_date = fields.Date(string="Date",help="Fecha")
    employee_id = fields.Many2one('hr.employee', string='Employee',help="Empleado")
    request_expected_date = fields.Date(string="Expected Date",help="Fecha de expedición")
    attachment_id_1 = fields.Many2many('ir.attachment', 'orientation_rel_1', string="Attachment",help="Archivo")
